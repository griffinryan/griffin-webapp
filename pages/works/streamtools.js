...
const Work = () => (
    <Layout title="StreamTools">
        <Container>
            ...
            <Image src="/images/works/thumb_streamtools.png" alt="StreamTools ASL Recognition" width={1280} height={720} priority sizes="100vw" style={{ width: '100%', height: 'auto', borderRadius: '0.375rem', marginBottom: '1rem' }} />
