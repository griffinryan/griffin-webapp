...
const Work = () => (
    <Layout title="Encryption Suite">
        <Container>
            ...
            <Image src="/images/works/thumb_encryption.png" alt="Encryption Suite Interface" width={1280} height={720} priority sizes="100vw" style={{ width: '100%', height: 'auto', borderRadius: '0.375rem', marginBottom: '1rem' }} />
