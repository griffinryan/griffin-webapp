...
const Work = () => (
    <Layout title="Dream Requiem">
        <Container>
            ...
            <Image src="/images/works/thumb_dreamrequiem.png" alt="Dream Requiem Engine" width={1280} height={720} priority sizes="100vw" style={{ width: '100%', height: 'auto', borderRadius: '0.375rem', marginBottom: '1rem' }} />
