...
const Work = () => (
    <Layout title='Dungeon Adventure'>
        <Container>
            ...
            <Image src="/images/works/thumb_dungeon.png" alt="Dungeon Adventure gameplay" width={1280} height={720} priority sizes="100vw" style={{ width: '100%', height: 'auto', borderRadius: '0.375rem', marginBottom: '1rem' }} />
