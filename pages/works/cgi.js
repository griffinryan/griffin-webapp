...
const Work = () => (
    <Layout title='A CGI Study'>
        <Container>
            ...
            <Image src="/images/works/thumb_cgi.png" alt="CGI Study visualization" width={1280} height={720} priority sizes="100vw" style={{ width: '100%', height: 'auto', borderRadius: '0.375rem', marginBottom: '1rem' }} />
