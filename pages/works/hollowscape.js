...
const Work = () => (
    <Layout title='Hollowscape'>
        <Container>
            ...
            <Image src="/images/works/thumb_hollowscape.png" alt="Hollowscape gameplay" width={1280} height={720} priority sizes="100vw" style={{ width: '100%', height: 'auto', borderRadius: '0.375rem', marginBottom: '1rem' }} />
